...
function amap_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_adherents'] = array(
		...
		'field'=> array(
			...
			'abandon'            => 'tinytext NOT NULL DEFAULT ""',
			'maj'                => 'TIMESTAMP'
		),
		'key' => array(
